...
$(MEM_0)_SPAN := 0x0000e400
$(MEM_0)_HIERARCHICAL_PATH := ImagemA
$(MEM_0)_WIDTH := 8
...
.PHONY: ImagemA
ImagemA: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_END := 0x0004e3ff
$(MEM_1)_SPAN := 0x0000e400
$(MEM_1)_HIERARCHICAL_PATH := ImagemB
$(MEM_1)_WIDTH := 8
...
.PHONY: ImagemB
ImagemB: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: ImagemC
MEM_2 := SSDNiosSoftwareEmbarcado_ImagemC
$(MEM_2)_NAME := ImagemC
...
$(MEM_2)_END := 0x0003e3ff
$(MEM_2)_SPAN := 0x0000e400
$(MEM_2)_HIERARCHICAL_PATH := ImagemC
$(MEM_2)_WIDTH := 8
...
.PHONY: ImagemC
ImagemC: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: MemoriaPrograma
MEM_3 := SSDNiosSoftwareEmbarcado_MemoriaPrograma
$(MEM_3)_NAME := MemoriaPrograma
...
$(MEM_3)_START := 0x00020000
$(MEM_3)_END := 0x0002ffff
$(MEM_3)_SPAN := 0x00010000
$(MEM_3)_HIERARCHICAL_PATH := MemoriaPrograma
$(MEM_3)_WIDTH := 8
...
MemoriaPrograma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
